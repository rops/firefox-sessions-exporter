...
Our work lives in a context of a smart and self-aware mobile operating system (i.e.
...
way that the user can resume her task like nothing changed. \\
 \\
Once stated this, our \emph{goal} is to make sure that the OS become aware of this kind of situations and smartly react to them, in order to guarantee a better user experience
to support the defined scenarios. We aim to achieve this goal by allowing the user to restore and
