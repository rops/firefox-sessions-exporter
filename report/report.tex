...
\todo[inline]{ale aveva scritto: Problema - se cade la connessione l'OS non riesce a ripristinarla completamente..ho scritto questo ma sarebbe da allungare}
...
\end{enumerate}
\todo[inline]{Ale aveva scritto: salvare la sessione x better user exp a supporto dei 3 casi precedenti...come sempre cè da allungare :)}
